  ...
  return (
    <div className={styles.termsOfServiceContainer}>
      ...
      <section>
        ...
        <p className={styles.paragraph}>
          Our website provides [description of services, e.g., information about
          our products/services, a platform for users to interact, etc.]. We
      ...
      <section>
        ...
        <ul className={styles.list}>
          ...
          <li>
            You agree not to upload or transmit any harmful or disruptive
            content.
          </li>
          <li>
      ...
      <section>
        ...
        <p className={styles.paragraph}>
          ...
          images, is protected by intellectual property laws. You may not
      ...
      <section>
        ...
        <p className={styles.paragraph}>
          ...
          regarding the website&apos;s operation or content.
        </p>
      </section>
      ...
      <section>
        ...
        <p className={styles.paragraph}>
          ...
          or relating to your use of the website.
        </p>
      </section>
      ...
      <section>
        ...
        <p className={styles.paragraph}>
          ...
          revised terms on the website. Your continued use of the website after
      ...
      <section>
        ...
        <p className={styles.paragraph}>
          ...
          us at [Your Contact Information, e.g., email address].
        </p>
      </section>
    </div>
  );
